...
@section("scripts")
    <script src="{{asset("assets/pages/scripts/reserva/crear.js")}}" type="text/javascript"></script>
    <!-- DATEPICKER-->
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{route('actualizar_reserva', ['id' => $data->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf @method("put")

                    <div class="card {{$card_color}} card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Ficha Reserva | <i>{{$data->cliente->full_name}}-{{$data->codigo}}</i></h3>
