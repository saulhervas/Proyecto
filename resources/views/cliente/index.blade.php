                ...
                <div class="card {{$card_color}} card-outline">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            @if (can('añadir-clientes',false))
                                <a href="{{route('crear_cliente')}}" class="btn btn-block btn-success btn-sm d-inline mr-4">
                        ...
                        <table id="tabla-data" class="table table-hover table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr >
                                    <td align="center">
                                        @if ($data->foto)
                                          <a href="/storage/cliente/{{$data->id}}/foto/{{$data->foto}}" data-toggle="lightbox">
                                            <img src="/storage/cliente/{{$data->id}}/foto/{{$data->foto}}" class="img-circle elevation-2" height="40">
                                          </a>
                                        @endif
                                    </td>
