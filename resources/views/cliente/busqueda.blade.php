...
<form action="{{route('busqueda_cliente')}}" id="form-busqueda" class="form-horizontal" method="POST" autocomplete="off"  style='@if (isset($busqueda)) display:block @else display:none @endif'>
    @csrf
